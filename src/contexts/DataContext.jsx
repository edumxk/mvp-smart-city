...
const initialReports = [
  ...
  { id: 1, author: 'Joao_Motoboy', type: 'Buraco', address: 'Av. Tocantins, Setor Morada do Sol', photo: 'https://images.unsplash.com/photo-1598609538183-a733734a704e?q=80&w=870&auto=format&fit=crop', location: { lat: -10.3235, lng: -48.2911 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 12 },
  { id: 2, author: 'Joao_Motoboy', type: 'Lâmpada queimada', address: 'Rua T-1, Setor Santa Fé', photo: 'https://images.unsplash.com/photo-1533311825220-72c1c7a4f944?q=80&w=774&auto=format&fit=crop', location: { lat: -10.3281, lng: -48.2954 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 25 },
  { id: 3, author: 'Joao_Motoboy', type: 'Buraco', address: 'Rua T-5, Aureny III', photo: 'https://images.unsplash.com/photo-1617112524724-8c88556a3a46?q=80&w=774&auto=format&fit=crop', location: { lat: -10.3352, lng: -48.3001 }, severity: 'Baixo', status: 'Resolvido', timestamp: Date.now() - 259200000, likes: 8 },
  { id: 4, author: 'Joao_Motoboy', type: 'Lixo', address: 'Av. Perimetral, Jardim Aureny IV', photo: 'https://images.unsplash.com/photo-1620755322398-e5e69e7b1a5a?q=80&w=870&auto=format&fit=crop', location: { lat: -10.3299, lng: -48.2987 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 15 },
  // --- Reportes da Cláudia Mendes (Centro/Norte) ---
  { id: 5, author: 'Profa_Claudia', type: 'Lixo', address: 'Quadra 104 Norte, Av. JK', photo: 'https://images.unsplash.com/photo-1604176422213-91215570222a?q=80&w=774&auto=format&fit=crop', location: { lat: -10.1741, lng: -48.3325 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 28 },
  { id: 6, author: 'Profa_Claudia', type: 'Lâmpada queimada', address: 'Quadra 208 Norte, Al. 2', photo: 'https://images.unsplash.com/photo-1619623696624-9a8b1a789312?q=80&w=774&auto=format&fit=crop', location: { lat: -10.1795, lng: -48.3351 }, severity: 'Médio', status: 'Resolvido', timestamp: Date.now() - 172800000, likes: 18 },
  { id: 7, author: 'Profa_Claudia', type: 'Buraco', address: 'Quadra 110 Sul, Av. LO-03', photo: 'https://images.unsplash.com/photo-1621362241515-3b95c8c5a4d0?q=80&w=774&auto=format&fit=crop', location: { lat: -10.1888, lng: -48.3303 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 22 },
  { id: 8, author: 'Profa_Claudia', type: 'Lixo', address: 'Praça dos Girassóis', photo: 'https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?q=80&w=870&auto=format&fit=crop', location: { lat: -10.1812, lng: -48.3289 }, severity: 'Baixo', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 10 },
  { id: 9, author: 'Profa_Claudia', type: 'Lâmpada queimada', address: 'Quadra 404 Norte, Rua 12', photo: 'https://images.unsplash.com/photo-1582236148285-a4b512cdef8e?q=80&w=774&auto=format&fit=crop', location: { lat: -10.1711, lng: -48.3398 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 432000000, likes: 30 },
  // --- Reportes do Roberto Almeida (Plano Diretor Sul) ---
  { id: 10, author: 'Roberto_Inova', type: 'Buraco', address: 'Quadra 602 Sul, Av. NS-02', photo: 'https://images.unsplash.com/photo-1524584249822-b7a5a8111e15?q=80&w=870&auto=format&fit=crop', location: { lat: -10.2450, lng: -48.3221 }, severity: 'Alto', status: 'Resolvido', timestamp: Date.now() - 86400000, likes: 19 },
  { id: 11, author: 'Roberto_Inova', type: 'Lâmpada queimada', address: 'Quadra 806 Sul, Av. LO-19', photo: 'https://images.unsplash.com/photo-1625044225892-2a0788616117?q=80&w=774&auto=format&fit=crop', location: { lat: -10.2515, lng: -48.3288 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 26 },
  { id: 12, author: 'Roberto_Inova', type: 'Lixo', address: 'Quadra 507 Sul, Al. 5', photo: 'https://images.unsplash.com/photo-1574974671999-24b7df457462?q=80&w=774&auto=format&fit=crop', location: { lat: -10.2398, lng: -48.3195 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 11 },
];

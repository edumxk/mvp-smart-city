...
const initialReports = [
  ...
  { id: 1, author: 'Joao_Motoboy', type: 'Buraco', photo: 'https://placehold.co/600x400/7d7d7d/FFFFFF?text=Buraco+na+Via', location: { lat: -10.3235, lng: -48.2911 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 12 },
  { id: 2, author: 'Joao_Motoboy', type: 'Lâmpada queimada', photo: 'https://placehold.co/600x400/000000/FFFFFF?text=Poste+Apagado', location: { lat: -10.3281, lng: -48.2954 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 25 },
  { id: 3, author: 'Joao_Motoboy', type: 'Buraco', photo: 'https://placehold.co/600x400/7d7d7d/FFFFFF?text=Asfalto+Cedendo', location: { lat: -10.3352, lng: -48.3001 }, severity: 'Baixo', status: 'Resolvido', timestamp: Date.now() - 259200000, likes: 8 },
  { id: 4, author: 'Joao_Motoboy', type: 'Lixo', photo: 'https://placehold.co/600x400/964B00/FFFFFF?text=Lixo+na+Calçada', location: { lat: -10.3299, lng: -48.2987 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 15 },
  // --- Reportes da Cláudia Mendes (Centro/Norte) ---
  { id: 5, author: 'Profa_Claudia', type: 'Lixo', photo: 'https://placehold.co/600x400/964B00/FFFFFF?text=Lixo+Perto+da+Escola', location: { lat: -10.1741, lng: -48.3325 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 28 },
  { id: 6, author: 'Profa_Claudia', type: 'Lâmpada queimada', photo: 'https://placehold.co/600x400/000000/FFFFFF?text=Praça+Escura', location: { lat: -10.1795, lng: -48.3351 }, severity: 'Médio', status: 'Resolvido', timestamp: Date.now() - 172800000, likes: 18 },
  { id: 7, author: 'Profa_Claudia', type: 'Buraco', photo: 'https://placehold.co/600x400/7d7d7d/FFFFFF?text=Cratera+na+Rua', location: { lat: -10.1888, lng: -48.3303 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 22 },
  { id: 8, author: 'Profa_Claudia', type: 'Lixo', photo: 'https://placehold.co/600x400/964B00/FFFFFF?text=Lixeira+Quebrada', location: { lat: -10.1812, lng: -48.3289 }, severity: 'Baixo', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 10 },
  { id: 9, author: 'Profa_Claudia', type: 'Lâmpada queimada', photo: 'https://placehold.co/600x400/000000/FFFFFF?text=Rua+Residencial', location: { lat: -10.1711, lng: -48.3398 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 432000000, likes: 30 },
  // --- Reportes do Roberto Almeida (Plano Diretor Sul) ---
  { id: 10, author: 'Roberto_Inova', type: 'Buraco', photo: 'https://placehold.co/600x400/7d7d7d/FFFFFF?text=Problema+no+Asfalto', location: { lat: -10.2450, lng: -48.3221 }, severity: 'Alto', status: 'Resolvido', timestamp: Date.now() - 86400000, likes: 19 },
  { id: 11, author: 'Roberto_Inova', type: 'Lâmpada queimada', photo: 'https://placehold.co/600x400/000000/FFFFFF?text=Avenida+Principal', location: { lat: -10.2515, lng: -48.3288 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 26 },
  { id: 12, author: 'Roberto_Inova', type: 'Lixo', photo: 'https://placehold.co/600x400/964B00/FFFFFF?text=Entulho+de+Obra', location: { lat: -10.2398, lng: -48.3195 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 11 },
];

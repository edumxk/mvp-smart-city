...
const initialReports = [
  ...
  { id: 1, author: 'Joao_Motoboy', type: 'Buraco', photo: 'https://i.imgur.com/8QkH7zT.jpeg', location: { lat: -10.3235, lng: -48.2911 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 12 },
  { id: 2, author: 'Joao_Motoboy', type: 'Lâmpada queimada', photo: 'https://i.imgur.com/O1b3p0H.jpeg', location: { lat: -10.3281, lng: -48.2954 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 25 },
  { id: 3, author: 'Joao_Motoboy', type: 'Buraco', photo: 'https://i.imgur.com/nJ6Y2k8.jpeg', location: { lat: -10.3352, lng: -48.3001 }, severity: 'Baixo', status: 'Resolvido', timestamp: Date.now() - 259200000, likes: 8 },
  { id: 4, author: 'Joao_Motoboy', type: 'Lixo', photo: 'https://i.imgur.com/kBGm2W4.jpeg', location: { lat: -10.3299, lng: -48.2987 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 15 },
  // --- Reportes da Cláudia Mendes (Centro/Norte) ---
  { id: 5, author: 'Profa_Claudia', type: 'Lixo', photo: 'https://i.imgur.com/Yh3wQc0.jpeg', location: { lat: -10.1741, lng: -48.3325 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 86400000, likes: 28 },
  { id: 6, author: 'Profa_Claudia', type: 'Lâmpada queimada', photo: 'https://i.imgur.com/D4ICghL.jpeg', location: { lat: -10.1795, lng: -48.3351 }, severity: 'Médio', status: 'Resolvido', timestamp: Date.now() - 172800000, likes: 18 },
  { id: 7, author: 'Profa_Claudia', type: 'Buraco', photo: 'https://i.imgur.com/wP4kZ9F.jpeg', location: { lat: -10.1888, lng: -48.3303 }, severity: 'Médio', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 22 },
  { id: 8, author: 'Profa_Claudia', type: 'Lixo', photo: 'https://i.imgur.com/8Fk3XOf.jpeg', location: { lat: -10.1812, lng: -48.3289 }, severity: 'Baixo', status: 'Recebido', timestamp: Date.now() - 345600000, likes: 10 },
  { id: 9, author: 'Profa_Claudia', type: 'Lâmpada queimada', photo: 'https://i.imgur.com/kO3tN7A.jpeg', location: { lat: -10.1711, lng: -48.3398 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 432000000, likes: 30 },
  // --- Reportes do Roberto Almeida (Plano Diretor Sul) ---
  { id: 10, author: 'Roberto_Inova', type: 'Buraco', photo: 'https://i.imgur.com/sS5A9jC.jpeg', location: { lat: -10.2450, lng: -48.3221 }, severity: 'Alto', status: 'Resolvido', timestamp: Date.now() - 86400000, likes: 19 },
  { id: 11, author: 'Roberto_Inova', type: 'Lâmpada queimada', photo: 'https://i.imgur.com/qL3P2pY.jpeg', location: { lat: -10.2515, lng: -48.3288 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 172800000, likes: 26 },
  { id: 12, author: 'Roberto_Inova', type: 'Lixo', photo: 'https://i.imgur.com/WbZ3Rj5.jpeg', location: { lat: -10.2398, lng: -48.3195 }, severity: 'Alto', status: 'Recebido', timestamp: Date.now() - 259200000, likes: 11 },
];
